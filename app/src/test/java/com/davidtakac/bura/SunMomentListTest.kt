...
class SunMomentListTest {
    ...
    fun `splits into future moments`() {
        ...
        assertTrue(threeMoments[0].event == SunEvent.Set)
        assertTrue(threeMoments[0].time == firstSunset)
        assertTrue(threeMoments[1].event == SunEvent.Rise)
        ...
        assertTrue(twoMoments[0].event == SunEvent.Rise)
        assertTrue(twoMoments[0].time == firstSunrise)
        assertTrue(twoMoments[1].event == SunEvent.Set)
        ...
        assertTrue(oneMoment[0].event == SunEvent.Set)
