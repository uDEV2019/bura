...
object CacheJsonSerialNames {
    ...
    // Moment field names
    const val MOMENT_TIME = "time"
    const val TEMPERATURE_UNIT = "unit"
    const val TEMPERATURE_VALUE = "value"
    const val POP_VALUE = "percent"
    ...
    const val PRECIPITATION_UNIT = "unit"
    const val UV_INDEX_VALUE = "uv_index"
    const val WIND_SPEED_VALUE = "speed_value"
    const val WIND_SPEED_UNIT = "speed_unit"
    const val WIND_DIRECTION_FROM_VALUE = "from_degrees"
    const val PRESSURE_VALUE = "value"
    const val PRESSURE_UNIT = "unit"
    const val VISIBILITY_VALUE = "value"
    const val VISIBILITY_UNIT = "unit"
    const val HUMIDITY_VALUE = "percent"
    const val CONDITION_WMO_CODE_VALUE = "wmo_code"
    const val CONDITION_IS_DAY_VALUE = "is_day"

    // Sun moment field names
    const val SUN_MOMENT_TIME = "time"
    const val SUN_EVENT = "event"
    const val SUN_SET = "set"
    const val SUN_RISE = "rise"
}